...
public class EnvioService {
    ...
    public List<Envio> readFilesToLocal(Prm param, Hashtable<String, Aeropuerto> aeroHash){
        ...
        try{
            ...
            for (int i = 0; i < listOfFiles.length; i++) { // lee los archivos de la ruta carpeta
                if (listOfFiles[i].isFile()) {
                    ...
                    listaEnvios.addAll(readFileToLocal(listOfFiles[i].getName(), rutaFolder, param, aeroHash));
                }
            }
    ...
    public List<Envio> readFileToLocal(String nombreArchivo, String rutaFolder, Prm param, Hashtable<String, Aeropuerto> aeroHash) throws FileNotFoundException, ParseException{
        List<Envio> result = null;
        String line="";
        try {
    ...
    Aeropuerto getByCodigoStringAux(String codigo, Hashtable<String, Aeropuerto>aeroHash){
